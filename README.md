...
[test-image]: https://github.com/stdlib-js/iter-flow/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/iter-flow/actions/workflows/test.yml?query=branch:v0.1.0
